...
echo "Installing Mission Control v2..."

cd /opt/mission-control

npm install octokit systeminformation socket.io chart.js
...
server.listen(port,()=>{
 console.log("Mission Control v2 running on",port)
})
SERVER
...
<div class="panel">
<h2>Wall Mode</h2>
<button onclick="wall()">Launch Wall Mode</button>
</div>
